...
impl Plugin for VrmPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(MtoonPlugin)
            ...
            .add_systems(
                Update,
                (set_vrm_scene, spawn_mtoon_markers, replace_mtoon_materials, vrm_bone_hook),
            );
    }
}
        ...
        if let Some(vrm0) = vrm.extensions.vrm0.as_ref() {
            if let Some(bones) = vrm0.humanoid.human_bones.as_ref() {
                for bone in bones {
                    ...
                    let bone_handle: &Handle<GltfNode> = vrm.gltf.nodes.get(bone_node as usize).unwrap();
                    ...
                    match bone_name.as_str() {
                        ...
                        "upperChest" => unfinished_humanoid_bones.upper_chest.replace(actual_entity),
                        "leftShoulder" => unfinished_humanoid_bones.left_shoulder.replace(actual_entity),
                        "rightShoulder" => unfinished_humanoid_bones.right_shoulder.replace(actual_entity),
                        "leftUpperArm" => unfinished_humanoid_bones.left_upper_arm.replace(actual_entity),
                        "rightUpperArm" => unfinished_humanoid_bones.right_upper_arm.replace(actual_entity),
                        "leftLowerArm" => unfinished_humanoid_bones.left_lower_arm.replace(actual_entity),
                        "rightLowerArm" => unfinished_humanoid_bones.right_lower_arm.replace(actual_entity),
                        ...
                        "leftUpperLeg" => unfinished_humanoid_bones.left_upper_leg.replace(actual_entity),
                        "rightUpperLeg" => unfinished_humanoid_bones.right_upper_leg.replace(actual_entity),
                        "leftLowerLeg" => unfinished_humanoid_bones.left_lower_leg.replace(actual_entity),
                        "rightLowerLeg" => unfinished_humanoid_bones.right_lower_leg.replace(actual_entity),
                        ...
                        "leftThumbProximal" => unfinished_humanoid_bones.left_thumb_proximal.replace(actual_entity),
                        "rightThumbProximal" => unfinished_humanoid_bones.right_thumb_proximal.replace(actual_entity),
                        "leftThumbIntermediate" => unfinished_humanoid_bones.left_thumb_intermediate.replace(actual_entity),
                        "rightThumbIntermediate" => unfinished_humanoid_bones.right_thumb_intermediate.replace(actual_entity),
                        "leftThumbDistal" => unfinished_humanoid_bones.left_thumb_distal.replace(actual_entity),
                        "rightThumbDistal" => unfinished_humanoid_bones.right_thumb_distal.replace(actual_entity),
                        "leftIndexProximal" => unfinished_humanoid_bones.left_index_proximal.replace(actual_entity),
                        "rightIndexProximal" => unfinished_humanoid_bones.right_index_proximal.replace(actual_entity),
                        "leftIndexIntermediate" => unfinished_humanoid_bones.left_index_intermediate.replace(actual_entity),
                        "rightIndexIntermediate" => unfinished_humanoid_bones.right_index_intermediate.replace(actual_entity),
                        "leftIndexDistal" => unfinished_humanoid_bones.left_index_distal.replace(actual_entity),
                        "rightIndexDistal" => unfinished_humanoid_bones.right_index_distal.replace(actual_entity),
                        "leftMiddleProximal" => unfinished_humanoid_bones.left_middle_proximal.replace(actual_entity),
                        "rightMiddleProximal" => unfinished_humanoid_bones.right_middle_proximal.replace(actual_entity),
                        "leftMiddleIntermediate" => unfinished_humanoid_bones.left_middle_intermediate.replace(actual_entity),
                        "rightMiddleIntermediate" => unfinished_humanoid_bones.right_middle_intermediate.replace(actual_entity),
                        "leftMiddleDistal" => unfinished_humanoid_bones.left_middle_distal.replace(actual_entity),
                        "rightMiddleDistal" => unfinished_humanoid_bones.right_middle_distal.replace(actual_entity),
                        "leftRingProximal" => unfinished_humanoid_bones.left_ring_proximal.replace(actual_entity),
                        "rightRingProximal" => unfinished_humanoid_bones.right_ring_proximal.replace(actual_entity),
                        "leftRingIntermediate" => unfinished_humanoid_bones.left_ring_intermediate.replace(actual_entity),
                        "rightRingIntermediate" => unfinished_humanoid_bones.right_ring_intermediate.replace(actual_entity),
                        "leftRingDistal" => unfinished_humanoid_bones.left_ring_distal.replace(actual_entity),
                        "rightRingDistal" => unfinished_humanoid_bones.right_ring_distal.replace(actual_entity),
                        "leftLittleProximal" => unfinished_humanoid_bones.left_little_proximal.replace(actual_entity),
                        "rightLittleProximal" => unfinished_humanoid_bones.right_little_proximal.replace(actual_entity),
                        "leftLittleIntermediate" => unfinished_humanoid_bones.left_little_intermediate.replace(actual_entity),
                        "rightLittleIntermediate" => unfinished_humanoid_bones.right_little_intermediate.replace(actual_entity),
                        "leftLittleDistal" => unfinished_humanoid_bones.left_little_distal.replace(actual_entity),
                        "rightLittleDistal" => unfinished_humanoid_bones.right_little_distal.replace(actual_entity),
                        others => unfinished_humanoid_bones.others.insert(others.to_string(), actual_entity),
                    };
                }
                commands.entity(entity)
                    .insert(HumanoidBones {
